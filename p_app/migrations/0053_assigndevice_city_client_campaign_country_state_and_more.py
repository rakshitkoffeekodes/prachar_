# Generated by Django 5.0.3 on 2024-06-18 12:37
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('p_app', '0052_remove_captain_c_assign_device_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ad_assign_status', models.CharField(choices=[('Pending', 'Pending'), ('Assign', 'Assign')], default='Pending', max_length=50, null=True, verbose_name='ASSIGN STATUS')),
                ('ad_created_at', models.DateTimeField(auto_now_add=True, verbose_name='Created At')),
                ('created_by', models.ForeignKey(blank=True, db_column='created_by', null=True, on_delete=django.db.models.deletion.PROTECT, to=settings.AUTH_USER_MODEL, verbose_name='Created By')),
            ],
            options={
                'verbose_name_plural': 'Assign Device',
                'unique_together': {('ad_brand_name', 'ad_model_no', 'ad_mac_address')},
            },
        ),
        migrations.CreateModel(
            name='City',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('VehicleLicense_Information', models.ForeignKey(null=True, on_delete=django.db.models.deletion.PROTECT, to='p_app.vehiclelicenseinformation', verbose_name='VEHICLE LICENSE')),
            ],
            options={
